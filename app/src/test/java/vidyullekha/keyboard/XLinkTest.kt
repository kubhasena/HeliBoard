...
import vidyullekha.keyboard.latin.App
...
import vidyullekha.keyboard.latin.utils.getKnownDictionariesForLocale
...
class XLinkTest { // Without the X, SubtypeTests fail with ClassCastException. WTF?
    ...
    @Test fun otherLinks() {
        listOf(Links.LICENSE, Links.LAYOUT_WIKI_URL, Links.WIKI_URL).forEach {
            checkLink(it)
        }
    }
