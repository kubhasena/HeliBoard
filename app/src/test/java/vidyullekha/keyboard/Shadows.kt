...
import vidyullekha.keyboard.latin.DictionaryFacilitatorImpl
...
class ShadowInputMethodManager2 : ShadowInputMethodManager() {
    ...
    override fun getInputMethodList() = listOf(
        if (BuildConfig.BUILD_TYPE == "debug" || BuildConfig.BUILD_TYPE == "debugNoMinify")
            InputMethodInfo("vidyullekha.keyboard.debug", "LatinIME", "Vidyullekha debug", null)
        else InputMethodInfo("vidyullekha.keyboard", "LatinIME", "Vidyullekha", null),
    )
    @Implementation
