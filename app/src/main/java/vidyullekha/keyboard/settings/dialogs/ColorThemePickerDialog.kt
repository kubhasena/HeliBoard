...
import vidyullekha.keyboard.latin.utils.EditButton
...
import vidyullekha.keyboard.settings.screens.SaveThoseColors
import vidyullekha.keyboard.settings.contentTextDirectionStyle
...
fun ColorThemePickerDialog(
    ...
    if (showLoadDialog) {
        ConfirmationDialog(
            ...
            content = {
                Text(stringResource(R.string.get_colors_message))
            },
            onConfirmed = {
