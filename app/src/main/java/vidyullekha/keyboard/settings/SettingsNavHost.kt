...
import vidyullekha.keyboard.latin.settings.getTransitionAnimationScale
import vidyullekha.keyboard.settings.screens.AboutScreen
import vidyullekha.keyboard.settings.screens.AdvancedSettingsScreen
import vidyullekha.keyboard.settings.screens.AppearanceScreen
import vidyullekha.keyboard.settings.screens.ColorsScreen
import vidyullekha.keyboard.settings.screens.DebugScreen
import vidyullekha.keyboard.settings.screens.DictionaryScreen
import vidyullekha.keyboard.settings.screens.GestureTypingScreen
import vidyullekha.keyboard.settings.screens.LanguageScreen
import vidyullekha.keyboard.settings.screens.MainSettingsScreen
import vidyullekha.keyboard.settings.screens.PersonalDictionariesScreen
import vidyullekha.keyboard.settings.screens.PersonalDictionaryScreen
import vidyullekha.keyboard.settings.screens.PreferencesScreen
import vidyullekha.keyboard.settings.screens.SecondaryLayoutScreen
import vidyullekha.keyboard.settings.screens.SubtypeScreen
import vidyullekha.keyboard.settings.screens.TextCorrectionScreen
import vidyullekha.keyboard.settings.screens.ToolbarScreen
import vidyullekha.keyboard.settings.screens.gesturedata.GestureDataScreen
import vidyullekha.keyboard.settings.screens.gesturedata.ReviewScreen
