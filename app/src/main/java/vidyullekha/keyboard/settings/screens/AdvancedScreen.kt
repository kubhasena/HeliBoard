...
import vidyullekha.keyboard.latin.BuildConfig
import vidyullekha.keyboard.latin.R
import vidyullekha.keyboard.latin.SystemBroadcastReceiver
...
import vidyullekha.keyboard.latin.utils.checkTimestampFormat
import vidyullekha.keyboard.latin.utils.prefs
import vidyullekha.keyboard.latin.utils.NextScreenIcon
import vidyullekha.keyboard.settings.SettingsContainer
import vidyullekha.keyboard.settings.preferences.ListPreference
import vidyullekha.keyboard.settings.SettingsWithoutKey
...
import vidyullekha.keyboard.settings.preferences.SliderPreference
import vidyullekha.keyboard.settings.preferences.SwitchPreference
import vidyullekha.keyboard.latin.utils.Theme
import vidyullekha.keyboard.settings.dialogs.TextInputDialog
import vidyullekha.keyboard.settings.preferences.BackupRestorePreference
import vidyullekha.keyboard.settings.preferences.LoadGestureLibPreference
import vidyullekha.keyboard.settings.preferences.TextInputPreference
