...
import vidyullekha.keyboard.settings.preferences.ReorderSwitchPreference
...
import vidyullekha.keyboard.settings.preferences.SwitchPreferenceWithEmojiDictWarning
...
fun createPreferencesSettings(context: Context) = listOf(
    ...
    Setting(context, Settings.PREF_BRAHMIC_INPUT_MODE, R.string.brahmic_mode, R.string.brahmic_mode_summary) {
        ListPreference(
            ...
            vidyullekha.keyboard.latin.brahmic.BrahmicUiState.setDependentVowels(false)
