...
import vidyullekha.keyboard.latin.common.ConstantsKt;
...
import vidyullekha.keyboard.latin.common.UnicodeSurrogate;
import vidyullekha.keyboard.latin.inputlogic.PrivateCommandPerformer;
import vidyullekha.keyboard.latin.settings.SpacingAndPunctuations;
import vidyullekha.keyboard.latin.utils.CapsModeUtils;
import vidyullekha.keyboard.latin.utils.DebugLogUtils;
import vidyullekha.keyboard.latin.utils.NgramContextUtils;
...
public final class RichInputConnection implements PrivateCommandPerformer {
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See vidyullekha.keyboard.latin.common.Constants.UnicodeSurrogate
    ...
    @Nullable private CharSequence getTextBeforeCursorAndDetectLaggyConnection(
        ...
        if ((mCommittedTextBeforeComposingText.length() > 0 || mComposingText.length() > 0)
            ...
            //     todo: understand where this inconsistent state comes from, is it really the other app's fault, or is it Vidyullekha?
