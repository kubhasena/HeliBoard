...
package vidyullekha.keyboard.latin;
...
import vidyullekha.keyboard.accessibility.AccessibilityUtils;
import vidyullekha.keyboard.compat.ConfigurationCompatKt;
import vidyullekha.keyboard.compat.EditorInfoCompatUtils;
import vidyullekha.keyboard.compat.ImeCompat;
import vidyullekha.keyboard.event.HapticEvent;
import vidyullekha.keyboard.keyboard.KeyboardActionListener;
import vidyullekha.keyboard.keyboard.KeyboardActionListenerImpl;
import vidyullekha.keyboard.keyboard.KeyboardMode;
import vidyullekha.keyboard.keyboard.emoji.EmojiPalettesView;
import vidyullekha.keyboard.keyboard.emoji.EmojiSearchActivity;
import vidyullekha.keyboard.keyboard.emoji.EmojiSearchActivityKt;
...
import vidyullekha.keyboard.latin.common.InsetsOutlineProvider;
import vidyullekha.keyboard.dictionarypack.DictionaryPackConstants;
import vidyullekha.keyboard.event.Event;
import vidyullekha.keyboard.event.InputTransaction;
import vidyullekha.keyboard.keyboard.Keyboard;
import vidyullekha.keyboard.keyboard.KeyboardId;
import vidyullekha.keyboard.keyboard.KeyboardLayoutSet;
import vidyullekha.keyboard.keyboard.KeyboardSwitcher;
import vidyullekha.keyboard.keyboard.MainKeyboardView;
import vidyullekha.keyboard.latin.SuggestedWords.SuggestedWordInfo;
import vidyullekha.keyboard.latin.common.ColorType;
import vidyullekha.keyboard.latin.common.Constants;
import vidyullekha.keyboard.latin.common.CoordinateUtils;
import vidyullekha.keyboard.latin.common.InputPointers;
import vidyullekha.keyboard.latin.common.ViewOutlineProviderUtilsKt;
import vidyullekha.keyboard.latin.define.DebugFlags;
import vidyullekha.keyboard.latin.inputlogic.InputLogic;
import vidyullekha.keyboard.latin.personalization.PersonalizationHelper;
import vidyullekha.keyboard.latin.settings.Settings;
import vidyullekha.keyboard.latin.settings.SettingsValues;
import vidyullekha.keyboard.latin.suggestions.SuggestionStripView;
import vidyullekha.keyboard.latin.suggestions.SuggestionStripViewAccessor;
import vidyullekha.keyboard.latin.touchinputconsumer.GestureConsumer;
import vidyullekha.keyboard.latin.utils.ColorUtilKt;
import vidyullekha.keyboard.latin.utils.FloatingKeyboardUtils;
import vidyullekha.keyboard.latin.utils.FoldableUtils;
import vidyullekha.keyboard.latin.utils.GestureDataGatheringKt;
import vidyullekha.keyboard.latin.utils.GestureDataGatheringSettings;
import vidyullekha.keyboard.latin.utils.InlineAutofillUtils;
import vidyullekha.keyboard.latin.utils.InputMethodPickerKt;
import vidyullekha.keyboard.latin.utils.JniUtils;
import vidyullekha.keyboard.latin.utils.KtxKt;
import vidyullekha.keyboard.latin.utils.LeakGuardHandlerWrapper;
import vidyullekha.keyboard.latin.utils.Log;
import vidyullekha.keyboard.latin.utils.BackgroundGatheringCache;
import vidyullekha.keyboard.latin.utils.RecapitalizeMode;
import vidyullekha.keyboard.latin.utils.StatsUtils;
import vidyullekha.keyboard.latin.utils.StatsUtilsManager;
import vidyullekha.keyboard.latin.utils.SubtypeLocaleUtils;
import vidyullekha.keyboard.latin.utils.SubtypeSettings;
import vidyullekha.keyboard.latin.utils.SubtypeState;
import vidyullekha.keyboard.latin.utils.ToolbarMode;
import vidyullekha.keyboard.settings.SettingsActivity2;
import kotlin.Unit;
...
public class LatinIME extends InputMethodService implements
    ...
    public void onComputeInsets(final InputMethodService.Insets outInsets) {
        ...
        if (isImeSuppressedByHardwareKeyboard() && !visibleKeyboardView.isShown()) {
            ...
            // way from OpenBoard to Vidyullekha (GH-702, GH-1455), but not setting anything seems to work
